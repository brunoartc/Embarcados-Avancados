...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/bruno/intelFPGA/18.1/quartus/"
}
...
alias file_copy {
  ...
  file copy -force $QSYS_SIMDIR/submodules/niosHello_nios2_gen2_0_cpu_dc_tag_ram.hex ./
  file copy -force $QSYS_SIMDIR/submodules/niosHello_nios2_gen2_0_cpu_dc_tag_ram.mif ./
  ...
  file copy -force $QSYS_SIMDIR/submodules/niosHello_nios2_gen2_0_cpu_bht_ram.dat ./
  file copy -force $QSYS_SIMDIR/submodules/niosHello_nios2_gen2_0_cpu_bht_ram.mif ./
  file copy -force $QSYS_SIMDIR/submodules/niosHello_nios2_gen2_0_cpu_ociram_default_contents.mif ./
  file copy -force $QSYS_SIMDIR/submodules/niosHello_nios2_gen2_0_cpu_ic_tag_ram.hex ./
  file copy -force $QSYS_SIMDIR/submodules/niosHello_nios2_gen2_0_cpu_dc_tag_ram.dat ./
  file copy -force $QSYS_SIMDIR/submodules/niosHello_nios2_gen2_0_cpu_ic_tag_ram.mif ./
  file copy -force $QSYS_SIMDIR/submodules/niosHello_nios2_gen2_0_cpu_ociram_default_contents.hex ./
  file copy -force $QSYS_SIMDIR/submodules/niosHello_nios2_gen2_0_cpu_ic_tag_ram.dat ./
  ...
  file copy -force $QSYS_SIMDIR/submodules/niosHello_nios2_gen2_0_cpu_bht_ram.hex ./
...
alias com {
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/niosHello_mm_interconnect_0_rsp_demux_001.sv"                     -work rsp_demux_001                               
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/niosHello_mm_interconnect_0_cmd_mux_001.sv"                       -work cmd_mux_001                                 
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/niosHello_mm_interconnect_0_router_003.sv"                        -work router_003                                  
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/niosHello_nios2_gen2_0_cpu_mult_cell.v"                           -work cpu                                         
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/niosHello_nios2_gen2_0_cpu.vo"                                    -work cpu                                         
